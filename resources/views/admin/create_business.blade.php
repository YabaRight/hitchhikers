                ...
                <div class=" ">
                    ...
                    @if($caCount >0)
                        <form role="form" method="post" action="{{url('admin/create_business')}}"
                            ...
                            <div class="form-group"><label class="control-label">Email</label><input
                                      value="{{old('email')}}" class="form-control" placeholder="Email" name="email"   type="text"></div>
                    ...
                    <div class="clearfix">&nbsp;</div>
                            ...
                            <div class="form-group"><label class="control-label">Description</label>
                                <textarea class="form-control" required name="biz_description">{{old('biz_description')}}</textarea></div>
