                    ...
                    @if($caCount >0)
                        <form role="form" method="post" action="{{url('admin/create_business')}}"
                            ...
                            <div class="form-group"><label class="control-label">Business Name
                                               ...
                                               value="{{old('name')}}" placeholder="Enter Business Name" type="text">
                            </div>
                            <div class="form-group"><label class="control-label">Email</label><input
                                        value="{{old('email')}}" class="form-control" placeholder="Email" name="email"
                                        type="text"></div>
                            ...
                            <div class="form-group"><label class="control-label">Image</label>
                                <input class="form-control" name="biz_image[]" accept="image/*" type="file" required
                                       multiple>
                                <span><i>max of 500kb</i></span>
                            </div>
                            <input  class="hidden" name="validate"   value="true"  type="text">
                            <div class="form-group"><label class="control-label">Description</label>
                                <textarea class="form-control" required
                                          name="biz_description">{{old('biz_description')}}</textarea></div>
                            <div class="form-group"><label class="control-label">Phone </label><input
                                        class="form-control" required placeholder="08163222222,07011222222" name="phone"
                                        value="{{old('phone')}}"
                                        type="text"></div>
                            ...
                            <div class="form-group"><label class="control-label">Open Hours</label><input
                                        class="form-control" required name="hours"
                                        placeholder="8am - 5pm, Monday to Friday" value="{{old('hours')}}"
                                        type="text"></div>
