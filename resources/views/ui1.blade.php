...
<header class="main-header">
    <div class="container">
        <div class="header-content">
            <a href="">
                <img src="{{url('img/site-identity.png')}}" alt="site identity" />
            </a>
            ...
            <div class="row">
                <div class="col-md-16 col-xs-24">
                    <div class="destination-box">
                        <div class="box-cover">
                            <a href="#">
                                <img src="{{url('img/destination-1.jpg')}}" alt="destination image" />
                            </a>
                        </div>
                ...
                <div class="col-md-8 col-sm-12 col-xs-24">
                    <div class="destination-box">
                        <div class="box-cover">
                            <a href="#">
                                <img src="{{url('img/destination-2.jpg')}}" alt="destination image" />
                            </a>
                        </div>
                ...
                <div class="col-md-8 col-sm-12 col-xs-24">
                    <div class="destination-box">
                        <div class="box-cover">
                            <a href="#">
                                <img src="{{url('img/destination-3.jpg')}}" alt="destination image" />
                            </a>
                        </div>
                ...
                <div class="col-md-8 col-sm-12 col-xs-24">
                    <div class="destination-box">
                        <div class="box-cover">
                            <a href="#">
                                <img src="{{url('img/destination-4.jpg')}}" alt="destination image" />
                            </a>
                        </div>
                ...
                <div class="col-md-8 col-sm-12 col-xs-24">
                    <div class="destination-box">
                        <div class="box-cover">
                            <a href="#">
                                <img src="{{url('img/destination-5.jpg')}}" alt="destination image" />
                            </a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-24">
                    <div class="boat-box">
                        <div class="box-cover">
                            <img src="{{url('img/boat-1.jpg')}}" alt="destination image" />
                        </div>
                ...
                <div class="col-sm-12 col-xs-24">
                    <div class="boat-box">
                        <div class="box-cover">
                            <img src="{{url('img/boat-2.jpg')}}" alt="destination image" />
                        </div>
                ...
                <div class="col-sm-12 col-xs-24">
                    <div class="boat-box">
                        <div class="box-cover">
                            <img src="{{url('img/boat-3.jpg')}}" alt="destination image" />
                        </div>
                ...
                <div class="col-sm-12 col-xs-24">
                    <div class="boat-box">
                        <div class="box-cover">
                            <img src="{{url('img/boat-4.jpg')}}" alt="destination image" />
                        </div>
