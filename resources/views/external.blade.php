...
<div id="editProperty" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width: 400px;  ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('admin/update_property') }}">
                    {{ csrf_field() }}
                    <div class="catinputhidden">
                    ...
                    <div class="form-group">
                        <input
                                ...
                                name="name" required
                                placeholder="Finance or Eatry"
                                class="form-control input-lg category_name">
                    </div>
                    <div class="form-group">
                                <textarea
                                        id=""
                                        type="text" rows="3"
                                        name="description" required
                                        class="form-control input-lg category_description">
                                    Description
